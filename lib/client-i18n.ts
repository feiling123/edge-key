...
const messages = {
  zh: {
    ...
    "nav.support": "联系客服",
    "nav.links": "功能导航",
    "nav.no_support": "暂无客服联系方式",
    "nav.search": "搜索",
    "nav.search_placeholder": "搜索商品名称",
    "nav.menu": "菜单",
    "nav.frontend": "返回前台",
    "language.label": "语言",
    "language.zh": "中文",
    ...
    "home.product_subtitle": "探索精选数字商品，自动下单，快速发货。",
    "home.all_products": "全部商品",
    "home.category_title": "分类",
    "home.search_title": "搜索",
    "home.product_count": "共 {count} 件商品",
    "home.sort_default": "默认",
    "home.sort_price": "价格",
    "home.sort_name": "名称",
    "home.auto_delivery": "自动发货",
    "home.view_detail": "查看详情",
    "home.view_all": "查看全部",
    "home.view_all_products": "查看全部",
    "home.hot": "热卖",
    "home.hot_badge": "惠",
    "home.blog_badge": "最新文章",
    "home.hero_subtitle": "自动发货数字商品商城，支持多支付方式和订单查询。",
    "home.default_product_desc": "自动发货，支付完成后可在订单页面查看发货内容。",
    "home.latest": "最新动态",
    "home.latest_subtitle": "公告、教程和运营说明集中展示。",
    "home.notice_desc": "查看最新公告、服务状态和购买提醒。",
    "home.about_desc": "了解站点信息、服务范围和联系方式。",
    "home.search_empty": "没有找到匹配商品，请换一个关键词。",
    ...
    "product.turnstile_required": "请完成人机验证",
    "product.turnstile_error": "人机验证失败，请刷新页面重试",
    "product.token_required": "下单凭证已过期，请刷新页面",
    ...
    "query.email": "联系邮箱",
    "query.email_placeholder": "请输入下单时填写的邮箱",
    "query.submit": "查询订单",
    "query.not_found": "未找到匹配订单，请检查订单号和联系邮箱。",
    "query.failed": "查询失败",
    ...
    "order.delivery": "发货内容",
    "order.download_delivery": "下载卡密",
    "order.copy_delivery": "点击复制卡密",
    "order.copied_delivery": "已复制第 {index} 条卡密",
    "order.copy_failed": "复制失败，请手动复制",
    "order.delivery_copy_hint": "点击任意卡密可自动复制。",
    "order.delivery_empty": "当前订单尚未支付或尚未自动发货。",
    "order.delivery_pending_empty": "订单已支付，正在自动发货，请稍后刷新查看。",
    ...
    "page.notice_title": "公告",
    "page.notice_empty": "暂无公告内容。",
    "page.about_title": "关于",
    "page.about_empty": "暂无关于内容。",
    "admin.actions": "操作",
    "admin.sort": "排序",
    "admin.status": "状态",
  ...
  en: {
    ...
    "nav.support": "Support",
    "nav.links": "Links",
    "nav.no_support": "No support contact yet",
    "nav.search": "Search",
    ...
    "home.product_subtitle": "Explore curated digital goods with automated ordering and fast delivery.",
    "home.all_products": "All Products",
    "home.category_title": "Categories",
    "home.search_title": "Search",
    "home.product_count": "{count} products",
    "home.sort_default": "Default",
    "home.sort_price": "Price",
    "home.sort_name": "Name",
    "home.auto_delivery": "Auto Delivery",
    "home.view_detail": "Details",
    "home.view_all": "View All",
    "home.view_all_products": "View All Products",
    "home.hot": "Hot",
    "home.hot_badge": "Hot",
    "home.blog_badge": "Latest Post",
    "home.hero_subtitle": "A digital goods storefront with automated delivery, payment integrations, and order lookup.",
    "home.default_product_desc": "Automated delivery. Delivery details are available on the order page after payment.",
    "home.latest": "Latest Updates",
    "home.latest_subtitle": "Announcements, guides, and operational notes.",
    "home.notice_desc": "View service announcements, status updates, and purchase notes.",
    "home.about_desc": "Learn about this storefront, service scope, and contact options.",
    "home.search_empty": "No matching products. Try another keyword.",
    ...
    "product.turnstile_required": "Please complete human verification",
    "product.turnstile_error": "Human verification failed, please refresh the page",
    "product.token_required": "Order token expired, please refresh the page",
    ...
    "query.email": "Email",
    "query.email_placeholder": "Enter the email used for this order",
    "query.submit": "Find Order",
    "query.not_found": "No matching order found. Check the order number and email.",
    ...
    "order.download_delivery": "Download",
    "order.copy_delivery": "Click to copy",
    "order.copied_delivery": "Copied item {index}",
    "order.copy_failed": "Copy failed. Please copy manually.",
    "order.delivery_copy_hint": "Click any delivered item to copy it.",
    "order.delivery_empty": "This order has not been paid or delivered yet.",
    "order.delivery_pending_empty": "This order is paid and delivery is being processed. Please refresh shortly.",
    "order.delivery_failed_empty": "This order is paid, but automatic delivery failed temporarily. The system will retry or support can help.",
    "order.no_pay_url": "Payment URL was not returned",
    "order.pay_failed": "Failed to start payment",
    "order.syncing": "Syncing payment status...",
    "blog.title": "Blog",
    ...
    "page.notice_title": "Notice",
    "page.notice_empty": "No notice content yet.",
    "page.about_title": "About",
    "page.about_empty": "No about content yet.",
